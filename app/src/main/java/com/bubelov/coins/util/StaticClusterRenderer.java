 ...
 */
public class StaticClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public StaticClusterRenderer(Context context, GoogleMap map, ClusterManager<T> clusterManager) {
        mMap = map;
    ...
    private class RenderTask implements Runnable {
        ...
        @SuppressLint("NewApi")
        public void run() {
            if (clusters.equals(StaticClusterRenderer.this.mClusters)) {
                mCallback.run();
                return;
            }
            ...
            if (StaticClusterRenderer.this.mClusters != null && SHOULD_ANIMATE) {
                existingClustersOnScreen = new ArrayList<Point>();
                for (Cluster<T> c : StaticClusterRenderer.this.mClusters) {
            ...
            mMarkers = newMarkers;
            StaticClusterRenderer.this.mClusters = clusters;
            mZoom = zoom;
